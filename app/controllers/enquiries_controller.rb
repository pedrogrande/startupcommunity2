class EnquiriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @enquiry.save
        ...
        EnquiryReceived.enquiry_mailer(@enquiry).deliver

        logger.info {"Starting second email"}
        EnquiryReceived.enquiry_response(@enquiry).deliver
  ...
  private
    ...
    def enquiry_params
      params.require(:enquiry).permit(:name, :phone, :email, :enquiry_type, :message)
    end
end
